...
if __name__ == "__main__":
    if len(sys.argv) < 5:
        print("Użycie: python ver_time.py <p_wykonywalny> <p_instancji> <p_wynikowy> <limit_czasu_s>")  # python ver_time.py python greedy.py in_155271_50.txt out_50_test.txt 5
        sys.exit(1)
